...
- [ ] Milestone B follow-up: replace the temporary rectangle renderer with the seeded sprite/tile pipeline (plus accompanying audio cues) outlined in `docs/plans/phase-1-mvp-plan.md#milestone-b`.
